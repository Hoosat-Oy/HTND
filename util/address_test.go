...
func TestParsePrefix(t *testing.T) {
	tests := []struct {
		...
		{"hoosat", util.Bech32PrefixHoosat, false},
		{"hoosattest", util.Bech32PrefixHoosatTest, false},
		{"hoosatsim", util.Bech32PrefixHoosatSim, false},
...
func TestPrefixToString(t *testing.T) {
	tests := []struct {
		...
		{util.Bech32PrefixHoosat, "hoosat"},
		{util.Bech32PrefixHoosatTest, "hoosattest"},
		{util.Bech32PrefixHoosatSim, "hoosatsim"},
		{util.Bech32PrefixUnknown, ""},
	}
