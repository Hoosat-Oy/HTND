...
func TestSignTxOutput(t *testing.T) {
	...
	for _, hashType := range hashTypes {
		for i := range tx.Inputs {
			...
			address, err := util.NewAddressPublicKey(serializedPubKey[:], util.Bech32PrefixHoosatTest)
			if err != nil {
	...
	for _, hashType := range hashTypes {
		for i := range tx.Inputs {
			...
			scriptAddr, err := util.NewAddressScriptHash(
				scriptPubKey.Script, util.Bech32PrefixHoosatTest)
			if err != nil {
...
var (
	privKeyD = secp256k1.SerializedPrivateKey{0x6b, 0x0f, 0xd8, 0xda, 0x54, 0x22, 0xd0, 0xb7,
		...
		0xd6, 0x0e, 0x06, 0x92}
	oldUncompressedScriptPubKey = &externalapi.ScriptPublicKey{Script: []byte{0x76, 0xa9, 0x14, 0xd1, 0x7c, 0xb5,
		0xeb, 0xa4, 0x02, 0xcb, 0x68, 0xe0, 0x69, 0x56, 0xbf, 0x32,
		0x53, 0x90, 0x0e, 0x0a, 0x86, 0xc9, 0xfa, 0x88, 0xac}, Version: 0}
	oldCompressedScriptPubKey = &externalapi.ScriptPublicKey{Script: []byte{0x76, 0xa9, 0x14, 0x27, 0x4d, 0x9f, 0x7f,
		0x61, 0x7e, 0x7c, 0x7a, 0x1c, 0x1f, 0xb2, 0x75, 0x79, 0x10,
		0x43, 0x65, 0x68, 0x27, 0x9d, 0x86, 0x88, 0xac}, Version: 0}
	p2pkScriptPubKey = &externalapi.ScriptPublicKey{Script: []byte{0x20, 0xb2, 0x52, 0xf0, 0x49, 0x85, 0x78, 0x03, 0x03,
		0xc8, 0x7d, 0xce, 0x51, 0x7f, 0xa8, 0x69, 0x0b,
		0x91, 0x95, 0xf4, 0xf3, 0x5c, 0x26, 0x73, 0x05,
		0x05, 0xa2, 0xee, 0xbc, 0x09, 0x38, 0x34, 0x3a, 0xac}, Version: 0}
	shortScriptPubKey = &externalapi.ScriptPublicKey{Script: []byte{0x76, 0xa9, 0x14, 0xd1, 0x7c, 0xb5,
		0xeb, 0xa4, 0x02, 0xcb, 0x68, 0xe0, 0x69, 0x56, 0xbf, 0x32,
		0x53, 0x90, 0x0e, 0x0a, 0x88, 0xac}, Version: 0}
)
